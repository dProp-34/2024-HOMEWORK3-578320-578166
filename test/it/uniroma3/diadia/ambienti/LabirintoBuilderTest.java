...
public class LabirintoBuilderTest {
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		assertTrue(!maze.getStanzaCorrente().getStanzeAdiacenti().containsValue(test));
		...
		assertEquals(mappa, maze.getStanzaCorrente().getStanzeAdiacenti());
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.get(nomeStanza).getAttrezzi()
				.contains(new Attrezzo(nomeAttrezzo, peso)));
		assertEquals(new Attrezzo(nomeAttrezzo, peso),
				this.labirintoBuilder.get(nomeStanza).getAttrezzo(nomeAttrezzo));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo, peso);
		List<Attrezzo> attrezzi = labirintoBuilder.get(nomeStanza).getAttrezzi();
	...
	public void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
		...
		// LinkedList<Stanza> listaStanze = labirintoBuilder.getListaStanze();
		assertEquals(new Attrezzo(nomeAttrezzo2, peso2), labirintoBuilder.get(nomeStanza1).getAttrezzo(nomeAttrezzo2));
		assertEquals(new Attrezzo(nomeAttrezzo1, peso1), labirintoBuilder.get(nomeStanza1).getAttrezzo(nomeAttrezzo1));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AttrezzoAggiuntoAllaSecondaStanza() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo1, peso1), labirintoBuilder.get(nomeStanza2).getAttrezzo(nomeAttrezzo1));
		assertEquals(new Attrezzo(nomeAttrezzo2, peso2), labirintoBuilder.get(nomeStanza2).getAttrezzo(nomeAttrezzo2));
	}
	...
	public void testLabirintoConStanzaMagica() {
		...
		StanzaMagica stanzaMagica = (StanzaMagica) labirintoBuilder.get(nomeStanzaMagica);
		// assertTrue(stanzaMagica.isMagica());
		assertThat(stanzaMagica, instanceOf(StanzaMagica.class));
	...
	public void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo2Inv, peso2_x2),
				labirintoBuilder.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo2Inv));
		assertEquals(new Attrezzo(nomeAttrezzo1, peso1),
				labirintoBuilder.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo1));
	}
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente, labirintoBuilder.get("stanza bloccata").getStanzaAdiacente(Direzione.nord));
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata, labirintoBuilder.get("stanza bloccata").getStanzaAdiacente(Direzione.nord));
	}
